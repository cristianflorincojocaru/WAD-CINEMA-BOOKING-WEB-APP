...
namespace cinemawebapp.Migrations
{
    ...
    [Migration("20260515215309_AddApplicationUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("cinemawebapp.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("cinemawebapp.Models.Promotion", b =>
                {
                    ...
                    b.Property<string>("LinkedTicketType")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("cinemawebapp.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("cinemawebapp.Models.Ticket", b =>
                {
                    ...
                    b.HasOne("cinemawebapp.Models.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade);
